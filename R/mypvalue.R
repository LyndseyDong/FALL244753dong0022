...
#' @param alpha The significance level for the test, which is alpha
#'
#' @return A plot of the t-distribution curve and a list containing the critical t-value of the test (q) and the calculated p-value.
#' @export
#'
#' @examples
