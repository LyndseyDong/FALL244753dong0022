...
#' @param ... Optional additional arguments/parameters
#'
#' @return A list of ci, x, and fun along with a plot of the bootstrap
#' @export
#'
#' @examples
#' \dontrun{myboot(x = sam, fun = "mean", alpha = 0.05, xlab = "mean", col = "palegoldenrod")}
